...
export function PortDot({ kind, nodeId, port, index }: { kind: NodeKind; nodeId: string; port: Port; index: number }) {
  ...
  const alwaysShowInput = kind === "generateImage" || kind === "hdRedraw" || kind === "hdRedraw2" || kind === "rhinoTest" || kind === "textImageLayout" || kind === "gridImage" || kind === "sceneImage" || kind === "industrialDesignImage" || kind === "productRemix" || kind === "imageChat" || kind === "sceneDirector" || kind === "taobaoPageDirector" || kind === "industrial_designer" || kind === "product_poster" || kind === "visual_director";
